...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class AndroidxFragmentKtxLibraryAccessors extends SubDependencyFactory {

        public AndroidxFragmentKtxLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>v161</b> with <b>androidx.fragment:fragment-ktx</b> coordinates and
         * with version reference <b>fragmentKtx</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getV161() {
            return create("androidx.fragment.ktx.v161");
        }
    ...
    public static class AndroidxPagingRuntimeLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>androidx.paging.runtime</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getKtx() {
    ...
    public static class AndroidxRoomLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>androidxRoomRoomRuntime</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
    ...
    public static class AndroidxRoomRoomLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>runtime3</b> with <b>androidx.room:room-runtime</b> coordinates and
         * with version reference <b>androidxRoomRoomRuntime</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getRuntime3() {
            return create("androidx.room.room.runtime3");
        }
    ...
    public static class ComSquareupLibraryAccessors extends SubDependencyFactory {
        private final ComSquareupLeakcanaryLibraryAccessors laccForComSquareupLeakcanaryLibraryAccessors = new ComSquareupLeakcanaryLibraryAccessors(owner);

        public ComSquareupLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>com.squareup.leakcanary</b>
         */
        public ComSquareupLeakcanaryLibraryAccessors getLeakcanary() {
            return laccForComSquareupLeakcanaryLibraryAccessors;
        }

    }

    public static class ComSquareupLeakcanaryLibraryAccessors extends SubDependencyFactory {
        private final ComSquareupLeakcanaryLeakcanaryLibraryAccessors laccForComSquareupLeakcanaryLeakcanaryLibraryAccessors = new ComSquareupLeakcanaryLeakcanaryLibraryAccessors(owner);

        public ComSquareupLeakcanaryLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>com.squareup.leakcanary.leakcanary</b>
         */
        public ComSquareupLeakcanaryLeakcanaryLibraryAccessors getLeakcanary() {
            return laccForComSquareupLeakcanaryLeakcanaryLibraryAccessors;
        }

    }

    public static class ComSquareupLeakcanaryLeakcanaryLibraryAccessors extends SubDependencyFactory {

        public ComSquareupLeakcanaryLeakcanaryLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>android</b> with <b>com.squareup.leakcanary:leakcanary-android</b> coordinates and
         * with version reference <b>squareupLeakcanaryAndroid</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getAndroid() {
            return create("com.squareup.leakcanary.leakcanary.android");
        }
    ...
    public static class LeakcanaryAndroidLibraryAccessors extends SubDependencyFactory {
        private final LeakcanaryAndroidNoLibraryAccessors laccForLeakcanaryAndroidNoLibraryAccessors = new LeakcanaryAndroidNoLibraryAccessors(owner);

        public LeakcanaryAndroidLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>leakcanary.android.no</b>
         */
        public LeakcanaryAndroidNoLibraryAccessors getNo() {
            return laccForLeakcanaryAndroidNoLibraryAccessors;
        }

    }

    public static class LeakcanaryAndroidNoLibraryAccessors extends SubDependencyFactory {

        public LeakcanaryAndroidNoLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>op</b> with <b>com.squareup.leakcanary:leakcanary-android-no-op</b> coordinates and
         * with version reference <b>squareupLeakcanaryAndroid</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getOp() {
            return create("leakcanary.android.no.op");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>androidxRoomRoomRuntime</b> with value <b>2.6.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getAndroidxRoomRoomRuntime() { return getVersion("androidxRoomRoomRuntime"); }
        ...
        /**
         * Version alias <b>squareupLeakcanaryAndroid</b> with value <b>2.12</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getSquareupLeakcanaryAndroid() { return getVersion("squareupLeakcanaryAndroid"); }
    ...
    public static class AndroidxVersionAccessors extends VersionFactory  {
        ...
        /**
         * Group of versions at <b>versions.androidx.paging</b>
         */
    ...
    public static class AndroidxPagingVersionAccessors extends VersionFactory  {

        public AndroidxPagingVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Version alias <b>androidx.paging.runtime</b> with value <b>3.1.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getRuntime() { return getVersion("androidx.paging.runtime"); }
