...
public final class BannerItemBinding implements ViewBinding {
  ...
  private BannerItemBinding(@NonNull ConstraintLayout rootView, @NonNull TextView bannerText,
  ...
  public static BannerItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new BannerItemBinding((ConstraintLayout) rootView, bannerText, bannerView);
    }
