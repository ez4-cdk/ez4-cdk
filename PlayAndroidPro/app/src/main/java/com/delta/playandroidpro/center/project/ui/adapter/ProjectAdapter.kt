...
import com.delta.playandroidpro.databinding.ProjectBinding


class ProjectAdapter(
    private val onItemClickListener: onProjectItemClickListener
):PagingDataAdapter<Article,ProjectAdapter.viewHolder>(COMPARATOR){
    ...
    inner class viewHolder(private val binding:ProjectBinding):RecyclerView.ViewHolder(binding.root){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): viewHolder {
        val binding = ProjectBinding.inflate(LayoutInflater.from(parent.context),parent,false)
