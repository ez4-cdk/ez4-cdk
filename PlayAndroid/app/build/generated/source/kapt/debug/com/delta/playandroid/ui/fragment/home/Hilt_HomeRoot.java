...
public abstract class Hilt_HomeRoot<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  Hilt_HomeRoot(int layoutID, Function1<? super View, ? extends VB> bindingInflater) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((HomeRoot_GeneratedInjector) this.generatedComponent()).injectHomeRoot(UnsafeCasts.<HomeRoot>unsafeCast(this));
    }
  }
