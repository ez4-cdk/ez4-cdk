...
public abstract class Hilt_PageInCards<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  Hilt_PageInCards(int layoutID, Function1<? super View, ? extends VB> bindingInflater) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PageInCards_GeneratedInjector) this.generatedComponent()).injectPageInCards(UnsafeCasts.<PageInCards>unsafeCast(this));
    }
  }
