...
public abstract class Hilt_SignUp<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  Hilt_SignUp(int layoutID, Function1<? super View, ? extends VB> bindingInflater) {
