...
public abstract class Hilt_ProjectRoot<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  Hilt_ProjectRoot(int layoutID, Function1<? super View, ? extends VB> bindingInflater) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ProjectRoot_GeneratedInjector) this.generatedComponent()).injectProjectRoot(UnsafeCasts.<ProjectRoot>unsafeCast(this));
    }
  }
