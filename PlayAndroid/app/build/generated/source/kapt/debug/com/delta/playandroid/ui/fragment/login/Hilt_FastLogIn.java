...
public abstract class Hilt_FastLogIn<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  Hilt_FastLogIn(int layoutID, Function1<? super View, ? extends VB> bindingInflater) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FastLogIn_GeneratedInjector) this.generatedComponent()).injectFastLogIn(UnsafeCasts.<FastLogIn>unsafeCast(this));
    }
  }
