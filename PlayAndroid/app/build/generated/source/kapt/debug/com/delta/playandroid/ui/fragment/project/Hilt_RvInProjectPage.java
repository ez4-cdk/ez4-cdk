...
public abstract class Hilt_RvInProjectPage<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  Hilt_RvInProjectPage(int layoutID, Function1<? super View, ? extends VB> bindingInflater) {
    super(layoutID, bindingInflater);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((RvInProjectPage_GeneratedInjector) this.generatedComponent()).injectRvInProjectPage(UnsafeCasts.<RvInProjectPage>unsafeCast(this));
    }
  }
