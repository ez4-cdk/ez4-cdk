...
public abstract class Hilt_SystemRoot extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_SystemRoot(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SystemRoot_GeneratedInjector) this.generatedComponent()).injectSystemRoot(UnsafeCasts.<SystemRoot>unsafeCast(this));
    }
  }
