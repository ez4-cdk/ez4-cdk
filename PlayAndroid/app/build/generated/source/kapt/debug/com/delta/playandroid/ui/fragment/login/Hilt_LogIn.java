...
public abstract class Hilt_LogIn<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  Hilt_LogIn(int layoutID, Function1<? super View, ? extends VB> bindingInflater) {
