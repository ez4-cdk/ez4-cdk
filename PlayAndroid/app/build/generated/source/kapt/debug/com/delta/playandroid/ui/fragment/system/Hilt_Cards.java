...
public abstract class Hilt_Cards<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  Hilt_Cards(int layoutID, Function1<? super View, ? extends VB> bindingInflater) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((Cards_GeneratedInjector) this.generatedComponent()).injectCards(UnsafeCasts.<Cards>unsafeCast(this));
    }
  }
