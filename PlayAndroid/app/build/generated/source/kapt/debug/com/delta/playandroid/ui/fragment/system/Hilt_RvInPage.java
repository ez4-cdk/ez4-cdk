...
public abstract class Hilt_RvInPage<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  Hilt_RvInPage(int layoutID, Function1<? super View, ? extends VB> bindingInflater) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((RvInPage_GeneratedInjector) this.generatedComponent()).injectRvInPage(UnsafeCasts.<RvInPage>unsafeCast(this));
    }
  }
